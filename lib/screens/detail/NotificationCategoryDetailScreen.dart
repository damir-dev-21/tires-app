                    ...
                    Expanded(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (ctx, index) => GestureDetector(
                            onTap: () async {
                              if (widget.notifications[index].status ==
                                      'Поступление' ||
                                ...
                                Message message_from_list =
                                    widget.notifications[index];
                                var content =
                                    json.decode(message_from_list.content)
                                ...
                                final Order order_finded = cartProvider.orders
                                    .firstWhere((element) =>
                                        element.userId ==
                                        widget.notifications[index].content);
                                context.router.push(
                                    OrderDetailRoute(order: order_finded));
                              }
                            },
                            child: Container(
